            ...
            <div class="row">
                <div class="col lg-8 sm-12">
                    ...
                    <div class="sm-shadow bg-white p-3 mb-4" data-aos="fade-up">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <span class="h5 mt-0 mb-1">Title</span>
                                <p class="mb-2">Ad porro dicant sed, nobis insolens per ad. Nam zril vivendum vulputate no. Alii populo facete vim cu, ne graeci accumsan has, erat adolescens efficiendi ut vim. Ex eruditi ocurreret vel.</p>
                                <a href="#" class="btn btn-rounded p-btn btn-tiny line">Replay</a>
                                <!-- Media Child Card Start -->
                                <div class="media mt-3">
                                    <!-- Media Card Img -->
                                    <img class="align-self-start mr-3 img-64 img-circle" src="img/thump-02.jpg" alt="Post image">
                                    <!-- Media Child Card Body Start -->
                                    <div class="media-body">
                                        <span class="h5 mt-0 mb-1">Title</span>
                                        <p class="mb-2">Ad porro dicant sed, nobis insolens per ad. Nam zril vivendum vulputate no. Alii populo facete vim cu, ne graeci accumsan has, erat adolescens efficiendi ut vim. Ex eruditi ocurreret vel.</p>
                                        <a href="#" class="btn btn-rounded p-btn btn-tiny line">Replay</a>
                                    </div>
                                    <!-- Media Child Card Body End -->
                                </div>
                                <!-- Media Child Card End -->
                            </div>
                            <!-- Media Card Body End -->
                        </div>
                        <!-- Media Card End -->
                    ...
                    <div class="sm-shadow bg-white p-3 mb-5" data-aos="fade-up">
                        ...
                        <!-- Form Start -->
                        <form action="#" class="row" id="comment-frm">

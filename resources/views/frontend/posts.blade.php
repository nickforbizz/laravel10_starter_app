            ...
            <div class="row">
                <div class="col lg-8 sm-12">
                    ...
                    <div class="row">
                            ...
                            <div class="blog-card sm-shadow p-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <span class="blog-head d-block">
                                        <a href="blog-details-left-sidebar.html">Ridens labitur evertitur pri cu, eam ne omnis definiebas.</a>
                                    </span>
                                </div>
                                <!-- Blog Header End -->
                                ...
                                <a href="blog-details-left-sidebar.html" class="btn arrow-btn p-0"><span>Read More</span><i class="ti-arrow-right"></i></a>
                            </div>
                            <!-- Blog Card End -->
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 mb-4">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 mb-4">
                            <!-- Blog Card Start -->
                            <div class="blog-card sm-shadow p-3" data-aos="fade-up" data-aos-duration="500">
                                <!-- Blog Image Start -->
                                <div class="blog-img mb-3">
                                    <a href="blog-details-left-sidebar.html" class="d-block setImgBack">
                                        <img src="img/blog/02.jpg" alt="Blog 02">

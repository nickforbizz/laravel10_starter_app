...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Roles
        Permission::create(['name' => 'create roles', 'guard_name' => 'web', 'created_by'=> $users->random()->id,]);
        Permission::create(['name' => 'edit roles', 'guard_name' => 'web', 'created_by'=> $users->random()->id,]);
        Permission::create(['name' => 'delete roles', 'guard_name' => 'web', 'created_by'=> $users->random()->id,]);


        // Permissions
        Permission::create(['name' => 'create permissions', 'guard_name' => 'web', 'created_by'=> $users->random()->id,]);
        Permission::create(['name' => 'edit permissions', 'guard_name' => 'web', 'created_by'=> $users->random()->id,]);
        Permission::create(['name' => 'delete permissions', 'guard_name' => 'web', 'created_by'=> $users->random()->id,]);


        // Params
        Permission::create(['name' => 'create params', 'guard_name' => 'web', 'created_by'=> $users->random()->id,]);
        Permission::create(['name' => 'edit params', 'guard_name' => 'web', 'created_by'=> $users->random()->id,]);
        Permission::create(['name' => 'delete params', 'guard_name' => 'web', 'created_by'=> $users->random()->id,]);
